...
const navByRole: Record<string, NavItem[]> = {
  ...
  LAB_TECH: [
    { label: 'Sample Queue',        path: '/lab/queue',   icon: FlaskConical  },
    { label: 'Enter Results',       path: '/lab/results', icon: ClipboardList },
    { label: 'Raw Material QC',     path: '/lab/raw-qc',  icon: TestTube      },
