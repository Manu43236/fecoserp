...
import { Plus, X, Search, ChevronRight, Truck, MapPin, Trash2, Package } from 'lucide-react'
      ...
      <div className="relative bg-white w-[440px] h-full shadow-2xl flex flex-col">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-1 min-h-0">
          <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
            ...
            {/* Truck # */}
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Truck Number</label>
              <input
                type="text"
                value={watch('truckNumber') ?? ''}
                onChange={e => setValue('truckNumber', e.target.value)}
            ...
            <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(['PLANNED', 'DISPATCHED', 'IN_PROGRESS', 'COMPLETED'] as RouteStatus[]).map(s => (
      ...
      <div className="relative bg-white w-[600px] h-full shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            {canEdit && (
              <button
                onClick={() => { if (confirm('Delete this route?')) deleteMutation.mutate() }}
    ...
    <div className="p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">{total} route{total !== 1 ? 's' : ''} total</p>
        </div>
        {canEdit && (
